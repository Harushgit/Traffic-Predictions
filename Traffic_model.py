...
data=pd.read_csv(r'C:\Users\njhar\Documents\automatic road traffic control\Batch-6(Automatic_Road_Traffic_Verifictaion_System)\Traffic_forecast_07.03.2023\traffic.csv')
print("<----Dataset----->")
print("******************")
print(data.head(20))
print()
